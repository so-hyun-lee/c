...
BEGIN_MESSAGE_MAP(CChatServerDlg, CDialogEx)
	...
	ON_NOTIFY(IPN_FIELDCHANGED, IDC_IPADDRESS1, &CChatServerDlg::OnIpnFieldchangedIpaddress1)
END_MESSAGE_MAP()
...
void CChatServerDlg::OnIpnFieldchangedIpaddress1(NMHDR *pNMHDR, LRESULT *pResult)
{
	LPNMIPADDRESS pIPAddr = reinterpret_cast<LPNMIPADDRESS>(pNMHDR);
	
	CIPAddressCtrl* pIPAddressCtrl = (CIPAddressCtrl*)pMain->GetDlgItem(IDC_IPADDRESS1);
